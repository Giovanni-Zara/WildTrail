...
import com.wildtrail.app.data.local.dao.LikeDao_Impl;
...
public final class WildTrailDatabase_Impl extends WildTrailDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(4) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `trail_reviews` (`reviewId` TEXT NOT NULL, `reviewerUid` TEXT NOT NULL, `hikeId` TEXT NOT NULL, `overallRating` INTEGER NOT NULL, `fatigueLevel` INTEGER NOT NULL, `pathClarity` INTEGER NOT NULL, `difficultyLevel` INTEGER NOT NULL, `mudRisk` INTEGER NOT NULL, `animalEncounterRisk` INTEGER NOT NULL, `waterAvailability` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL, PRIMARY KEY(`reviewId`))");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `user_follows` (`followerUid` TEXT NOT NULL, `followeeUid` TEXT NOT NULL, `notifyOnNewHike` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL, PRIMARY KEY(`followerUid`, `followeeUid`))");
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_user_follows_followeeUid` ON `user_follows` (`followeeUid`)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `followed_trails` (`userUid` TEXT NOT NULL, `hikeId` TEXT NOT NULL, `notifyOnNewReview` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL, PRIMARY KEY(`userUid`, `hikeId`))");
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_followed_trails_hikeId` ON `followed_trails` (`hikeId`)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `hike_comments` (`commentId` TEXT NOT NULL, `authorUid` TEXT NOT NULL, `hikeId` TEXT NOT NULL, `text` TEXT NOT NULL, `photoUrls` TEXT NOT NULL, `createdAt` INTEGER NOT NULL, PRIMARY KEY(`commentId`))");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `user_achievements` (`userUid` TEXT NOT NULL, `achievementId` TEXT NOT NULL, `earnedAt` INTEGER NOT NULL, PRIMARY KEY(`userUid`, `achievementId`))");
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_user_achievements_achievementId` ON `user_achievements` (`achievementId`)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `emergency_contacts` (`contactId` TEXT NOT NULL, `userUid` TEXT NOT NULL, `name` TEXT NOT NULL, `phoneNumber` TEXT NOT NULL, `relationship` TEXT, `isPrimary` INTEGER NOT NULL, `notifyOnFall` INTEGER NOT NULL, PRIMARY KEY(`contactId`))");
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsHikeLogs = new HashMap<String, TableInfo.Column>(29);
        ...
        _columnsHikeLogs.put("creatorUsername", new TableInfo.Column("creatorUsername", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsHikeLogs.put("creatorProfilePictureUrl", new TableInfo.Column("creatorProfilePictureUrl", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsHikeLogs.put("difficultyLevel", new TableInfo.Column("difficultyLevel", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsHikeLogs.put("mudRisk", new TableInfo.Column("mudRisk", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsHikeLogs.put("pathClarity", new TableInfo.Column("pathClarity", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsHikeLogs.put("fatigueLevel", new TableInfo.Column("fatigueLevel", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsHikeLogs.put("animalEncounterRisk", new TableInfo.Column("animalEncounterRisk", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsHikeLogs.put("waterAvailability", new TableInfo.Column("waterAvailability", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsHikeLogs.put("averageRating", new TableInfo.Column("averageRating", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsHikeLogs.put("reviewCount", new TableInfo.Column("reviewCount", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysHikeLogs = new HashSet<TableInfo.ForeignKey>(0);
        ...
        final HashMap<String, TableInfo.Column> _columnsTrailReviews = new HashMap<String, TableInfo.Column>(11);
        ...
        _columnsTrailReviews.put("overallRating", new TableInfo.Column("overallRating", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashSet<TableInfo.ForeignKey> _foreignKeysTrailReviews = new HashSet<TableInfo.ForeignKey>(0);
        ...
        final HashSet<TableInfo.ForeignKey> _foreignKeysUserFollows = new HashSet<TableInfo.ForeignKey>(0);
        ...
        final HashSet<TableInfo.ForeignKey> _foreignKeysFollowedTrails = new HashSet<TableInfo.ForeignKey>(0);
        ...
        final HashSet<TableInfo.ForeignKey> _foreignKeysHikeComments = new HashSet<TableInfo.ForeignKey>(0);
        ...
        final HashMap<String, TableInfo.Column> _columnsLikes = new HashMap<String, TableInfo.Column>(3);
        _columnsLikes.put("userUid", new TableInfo.Column("userUid", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsLikes.put("hikeId", new TableInfo.Column("hikeId", "TEXT", true, 2, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsLikes.put("createdAt", new TableInfo.Column("createdAt", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysLikes = new HashSet<TableInfo.ForeignKey>(0);
        final HashSet<TableInfo.Index> _indicesLikes = new HashSet<TableInfo.Index>(1);
        _indicesLikes.add(new TableInfo.Index("index_likes_hikeId", false, Arrays.asList("hikeId"), Arrays.asList("ASC")));
        ...
        if (!_infoLikes.equals(_existingLikes)) {
          return new RoomOpenHelper.ValidationResult(false, "likes(com.wildtrail.app.data.local.entity.LikeEntity).\n"
                  + " Expected:\n" + _infoLikes + "\n"
                  + " Found:\n" + _existingLikes);
        }
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "users","hike_logs","trail_reviews","user_follows","followed_trails","hike_comments","achievement_definitions","user_achievements","emergency_contacts","likes");
  }
